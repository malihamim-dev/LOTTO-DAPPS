...
export default function My_Earning_FAQ() {
    return (
        <div className=' rounded-3xl px-5 md:px-8 lg:px-10 xl:px-20 2xl:px-28  max-w-[1596px] mx-auto opacity-95 py-20 md:py-0' >
