...
export default function Auditing_And_Blockchain_Hero() {
  return (
      ...
      <div className=' grid md:grid-cols-6 lg:grid-cols-7 h-full lg:h-[85vh] xl:h-[70vh] items-center gap-x-5'>
        <div className=' col-span-3 lg:col-span-4'>
          <div className='space-y-2 pt-5 md:pt-10'>
            <h1 className='text-white font-bold text-3xl md:text-4xl lg:text-4xl xl:text-5xl text-center md:text-start '>Auditing And Blockchain 
            </h1>
