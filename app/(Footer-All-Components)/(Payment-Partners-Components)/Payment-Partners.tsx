...
export default function Payment_Partners() {
    return (
        <div className='px-5 md:px-8 lg:px-10 xl:px-20 2xl:px-28 max-w-[1596px] mx-auto opacity-95 pb-20 pt-10'>
            <h1 className='text-xl md:text-[26px] lg:text-3xl xl:text-[40px] font-bold text-white text-center'>Trusted Payment Partners</h1>
            <div>
