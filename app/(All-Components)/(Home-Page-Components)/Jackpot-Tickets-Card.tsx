        ...
        <div className="  px-5 md:px-8 lg:px-10 xl:px-28 2xl:px-28 max-w-[1596px] mx-auto pb-10">
                            ...
                            <div key={index} className="card group w-full h-[420px] bg-[#180A3C] rounded-[20px] relative overflow-hidden border border-[#FF5F1F] shadow-[0_10px_15px_-3px_rgba(0,0,0,0.05)] transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] font-sans text-white hover:-translate-y-1.5 hover:shadow-[0_5px_5px_5px_rgba(255,255,255,0.167)] hover:border-white active:-translate-y-1.5 active:scale-98">
                                ...
                                <div className="card__content px-5 pt-2 h-full flex flex-col gap-[0.75em] relative z-10">
                                    ...
                                    <div className="card__text flex justify-between gap-1">
                                        <div>
                                            <p className={`card__title ${smoochSans.className} text-2xl md:text-3xl lg:text-[27px] xl:text-3xl font-semibold text-white m-0 transition-all duration-300 ease-linear group-hover:text-[#ffffff]`}>
                                                {pak?.package_name}
                                            </p>
                                        </div>
                                            ...
                                            <div className="flex items-center gap-x-2">
                                                <FaRegHeart
                                                    className={pak.wishlist
                                                        ? "text-orange-400 text-xl  lg:text-2xl xl:text-3xl 2xl:text-4xl"
                                                        : "text-gray-400 text-xl  lg:text-2xl xl:text-3xl 2xl:text-4xl"} />
                                                <p className={`card__title ${smoochSans.className} text-2xl md:text-3xl font-thin m-0 transition-all duration-300 ease-linear group-hover:text-[#ffffff] group-hover:translate-x-0.5`}> {pak.wishlist_views}k</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="card__footer justify-between items-center mt-auto">
                                        <div className="flex items-center justify-between">
                                            <div className="text-white font-bold text-sm md:text-base  ">Winning Prize</div>
                                            <div className="text-white font-bold text-sm md:text-base"> ${pak.winning_money}</div>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <div className="text-white font-bold text-sm md:text-base">Ticket Prize</div>
                                            <div className="text-white font-bold text-sm md:text-base">${pak.ticket_price}</div>
                                        </div>
            ...
            <div>
                <div className='  mt-5 gap-10 pb-5'>
                    ...
                    <div className='grid md:grid-cols-2 lg:grid-cols-3 mt-5 md:mt-1 lg:mt-5 gap-4 lg:gap-5 xl:gap-7 2xl:gap-10 pb-5'>
                        {
                                                    ...
                                                    <div className="flex items-center gap-x-2">
                                                        <FaRegHeart
                                                            className={pak.wishlist
                                                                ? "text-orange-400 text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl"
                                                                : "text-gray-400 text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl"} />
                                                        <p className={`card__title ${smoochSans.className} text-2xl md:text-3xl font-thin m-0 transition-all duration-300 ease-linear group-hover:text-[#ffffff] group-hover:translate-x-0.5`}>
                                                            {pak.wishlist_views}k
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 mt-0 md:mt-1 lg:mt-5 gap-3 lg:gap-5 xl:gap-10 pb-5">
                        {/* LEFT */}
                        <div className=" md:col-span-1 lg:col-span-1 ">
                            {MatrixPackage.length > 0 && (() => {
                                ...
                                return (
                                    ...
                                    <>
                                        <div className="card group w-full h-[420px] bg-[#180A3C] rounded-[20px] relative overflow-hidden border border-[#FF5F1F] shadow-[0_10px_15px_-3px_rgba(0,0,0,0.05)] transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] font-sans text-white hover:-translate-y-1.5 hover:shadow-[0_5px_5px_5px_rgba(255,255,255,0.167)] hover:border-white active:-translate-y-1.5 active:scale-98">
                                                        ...
                                                        <div className="flex items-center gap-x-2">
                                                            <FaRegHeart
                                                                className={lastPackage.wishlist
                                                                    ? "text-orange-400 text-xl  lg:text-2xl xl:text-3xl 2xl:text-4xl"
                                                                    : "text-gray-400 text-xl  lg:text-2xl xl:text-3xl 2xl:text-4xl"} />
                                                            <p className={`card__title ${smoochSans.className} text-2xl md:text-3xl font-thin m-0 transition-all duration-300 ease-linear group-hover:text-[#ffffff] group-hover:translate-x-0.5`}> {lastPackage.wishlist_views}k</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="card__footer justify-between items-center mt-auto">
                                                    <div className="flex items-center justify-between">
                                                        <div className="text-white font-bold text-sm md:text-base  ">Winning Prize</div>
                                                        <div className="text-white font-bold text-sm md:text-base"> ${lastPackage.winning_money}</div>
                                                    </div>
                                                    <div className="flex items-center justify-between">
                                                        <div className="text-white font-bold text-sm md:text-base">Ticket Prize</div>
                                                        <div className="text-white font-bold text-sm md:text-base">${lastPackage.ticket_price}</div>
                                                    </div>
                                                    <div className="flex items-center justify-center mx-auto py-5">
                                                        <button className="group w-40 relative h-14 outline-none bg-transparent border-none text-sm font-bold text-white">
                                                            PLAY
                        ...
                        {/* RIGHT */}
                        <div className=" md:col-span-1 lg:col-span-2 mt-2 md:mt-0">
                            <BackgroundGradient className="relative flex-1 h-full rounded-[22px] bg-[#180A3C] dark:bg-zinc-900 overflow-hidden">
                                <Image
                                    src={addimage}
                                    alt="ad1"
                                    className="h-full w-full object-cover rounded-[22px] md:h-[410px] lg:h-[413px]  xl:h-[413px] 2xl:h-[400px]" />
                            </BackgroundGradient>
                        </div>
                    </div>
                </div>
